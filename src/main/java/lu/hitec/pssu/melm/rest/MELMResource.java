...
public class MELMResource {
	...
	@Produces(MediaType.TEXT_HTML)
	@Path("/icons/add")
	public Response performAddIcon(@Context final UriInfo uriInfo, @FormDataParam("displayName") final String displayName, @FormDataParam("largeIconFile") final InputStream file,
	...
	@Produces(MediaType.TEXT_HTML)
	@Path("/libraries/add")
	public Response performAddLibrary(@Context final UriInfo uriInfo, @FormDataParam("libraryName") final String libraryName, @FormDataParam("version") final String version,
			@FormDataParam("libraryIconFile") final InputStream file, @FormDataParam("libraryIconFile") final FormDataContentDisposition fileDisposition) {
	...
	public Response performAddLibraryIcon(@Context final UriInfo uriInfo, @FormParam("id") final long id, @FormParam("iconIndex") final int iconIndex, @FormParam("iconName") final String iconName,
			@FormParam("iconDescription") final String iconDescription, @FormParam("iconId") final long iconId) {
		if ((iconId == -1) || (iconName == null) || iconName.equalsIgnoreCase("") || (iconDescription == null) || iconDescription.equalsIgnoreCase("")) {
			final MapElementLibrary library = melmService.getLibrary(id);
	...
	public Response performAddProperty(@FormParam("id") final long id, @FormParam("uniqueName") @Nonnull final String uniqueName, @FormParam("type") @Nonnull final String type) {
	...
	public Response performCloneLibrary(@Context final UriInfo uriInfo, @FormDataParam("id") final long id, @FormDataParam("libraryName") final String libraryName,
			@FormDataParam("version") final String version, @FormDataParam("iconChoice") final String iconChoice, @FormDataParam("libraryIconFile") final InputStream file,
	...
	@Produces(MediaType.TEXT_HTML)
	@Path("/libraries/import")
	public Response performImportLibrary(@Context final UriInfo uriInfo, @FormDataParam("libraryName") final String libraryName, @FormDataParam("version") final String version,
			@FormDataParam("libraryFile") final InputStream file, @FormDataParam("libraryFile") final FormDataContentDisposition fileDisposition) {
		try {
	...
	public Response performUpdateLibrary(@Context final UriInfo uriInfo, @FormDataParam("id") final long id, @FormDataParam("libraryName") final String libraryName,
			@FormDataParam("version") final String version, @FormDataParam("libraryIconFile") final InputStream file, @FormDataParam("libraryIconFile") final FormDataContentDisposition fileDisposition) {
		if ((libraryName == null) || libraryName.equalsIgnoreCase("") || (version == null) || version.equalsIgnoreCase("")) {
			final MapElementLibrary library = melmService.getLibrary(id);
			final String error = "Library name and version are mandatory";
	...
	public Response performUpdateLibraryIcon(@Context final UriInfo uriInfo, @FormParam("libraryIconId") final long libraryIconId, @FormParam("iconIndex") final int iconIndex,
			@FormParam("iconName") final String iconName, @FormParam("iconDescription") final String iconDescription, @FormParam("iconId") final long iconId) {
	...
	public Response performUpdateProperty(@FormParam("id") final long id, @FormParam("uniqueName") @Nonnull final String uniqueName, @FormParam("type") @Nonnull final String type) {
		if ((uniqueName == null) || uniqueName.equalsIgnoreCase("") || (type == null) || type.equalsIgnoreCase("")) {
	...
	public Response performZipLibrary(@PathParam("name") @Nonnull final String name, @PathParam("majorVersion") final int majorVersion, @PathParam("minorVersion") final int minorVersion) {
		try {
