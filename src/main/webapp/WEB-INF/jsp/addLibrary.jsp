...
<body ng-controller="AddLibraryCtrl" ng-file-drop>
	...
	<div class="container">
		...
		<form method="POST" class="form-horizontal" role="form">
			<div class="jumbotron">
				<p>
					Click on the following button or drag and drop your file in order to select a <b>library icon</b>.
					<br />
					Then you can click on the 'add' button if you want to create the library or on the 'delete' button if you want to use another file.
				</p>
				<p>
					<span class="btn btn-primary btn-file">
						<span class="glyphicon glyphicon-file"></span>
						Browse&hellip; <input type="file" id="libraryIconFile" name="libraryIconFile" maxlength='1000000' accept='image/png' ng-file-select multiple />
					</span>
