...
<head>
<title>Pulse Collection - List of libraries</title>
	...
	<div class="container">
		...
		<div class="table-responsive">
			<table class="table table-striped">
				...
				<tr ng-repeat="library in resources | orderBy:predicate:reverse | startFrom: (currentPage - 1) * itemsPerPage | limitTo: itemsPerPage">
					<td align="center"><input type="checkbox" ng-model="library.checked"></td>
		...
		<ul class="nav nav-pills">
			...
			<li><button class="btn btn-delete" ng-disabled="!someSelected()" ng-click="confirmDeleteMultiple()"><span>Delete selected</span></button></li>
