		...
		<form method="POST" action="${ctx}/rest/icons/update" enctype='multipart/form-data' class="form-horizontal" role="form">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="anchor-wrapper ">
						<a href="" ng-click="setAnchor('SW')" ng-class="getClass('SW')" style="border-top-left-radius: 7px; position: absolute; top: 0px; left: 0px;"></a> <a href="" ng-click="setAnchor('S')"
							ng-class="getClass('S')" style="position: absolute; top: 0px; left: 80px;"></a> <a href="" ng-click="setAnchor('SE')" ng-class="getClass('SE')"
							style="border-top-right-radius: 7px; position: absolute; top: 0px; left: 160px;"></a> <a href="" ng-click="setAnchor('W')" ng-class="getClass('W')"
							style="position: absolute; top: 80px; left: 0px;"></a> <a href="" ng-click="setAnchor('E')" ng-class="getClass('E')" style="position: absolute; top: 80px; left: 160px;"></a> <a href=""
							ng-click="setAnchor('NW')" ng-class="getClass('NW')" style="border-bottom-left-radius: 7px; position: absolute; top: 160px; left: 0px;"></a> <a href="" ng-click="setAnchor('N')"
							ng-class="getClass('N')" style="position: absolute; top: 160px; left: 80px;"></a> <a href="" ng-click="setAnchor('NE')" ng-class="getClass('NE')"
							style="border-bottom-right-radius: 7px; position: absolute; top: 160px; left: 160px;"></a>
					</div>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div style="margin-top: 6px;">
						<input type="radio" name="iconChoice" ng-model="iconChoice" value="new">Upload a new icon
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div style="margin-top: 6px;">
						<input type="radio" name="iconSelectedChoice" ng-model="iconSelectedChoice" value="new">Upload a new "selected" icon

						<div class="input-group">
							<span class="input-group-btn">
								<span class="btn btn-primary btn-file" ng-disabled="iconSelectedChoice != 'new'">
									Browse&hellip; <input type="file" ng-disabled="iconSelectedChoice != 'new'" id="largeIconSelectedFile" name="largeIconSelectedFile" maxlength='1000000' accept='image/png'>
								</span>
							</span>
							<input type="text" class="form-control" readonly>
						</div>
