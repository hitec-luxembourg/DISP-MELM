app.controller('LibraryIconsCtrl', [ '$scope', '$document', 'melmService', function($scope, $document, melmService) {
  ...
  $scope.isFirst = function(id) {
    var result = $scope.resources && $scope.resources.icons && 0 < $scope.resources.icons.length && $scope.resources.icons[0].id === id;
    return result;
  };

  $scope.isLast = function(id) {
    var result = $scope.resources && $scope.resources.icons && 0 < $scope.resources.icons.length && $scope.resources.icons[$scope.resources.icons.length - 1].id === id;
    return result;
  };
