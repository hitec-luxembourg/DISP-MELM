...
@ContextConfiguration(locations = { "classpath:/ctx-config-test.xml", "classpath:/ctx-dao.xml", "classpath:/ctx-persistence-test.xml",
    "classpath:/ctx-integration-test.xml" })
public class MapElementLibraryIconDAOImplTest {
  ...
  public void testGetPrevious() {
    ...
    final MapElementIcon i0 = mapElementIconDAO.addMapElementIcon("Hash_00", 100, "Name_00", MapElementIconAnchor.NE);
    ...
    final MapElementIcon i1 = mapElementIconDAO.addMapElementIcon("Hash_01", 100, "Name_01", MapElementIconAnchor.NE);
    ...
    final MapElementIcon i2 = mapElementIconDAO.addMapElementIcon("Hash_02", 100, "Name_02", MapElementIconAnchor.NE);
